...
app.controller('AppController', function ($scope, $routeParams, $route, $location, $window) {
    ...
    $scope.login = function (password) {
        var passwordTrimmedLowercase = password.trim().toLowerCase();
        var success = password && (
                passwordTrimmedLowercase === 'thb'
                || passwordTrimmedLowercase === 'marmar'
                || passwordTrimmedLowercase === 'fab99'
                || passwordTrimmedLowercase === 'sol22' // marzar
            );
